...
public class QuickstartApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Behavior<NotUsed> rootBehavior = Behaviors.setup(context -> {
            ActorRef<DeliveryApp.DeliveryCommand> deliveryActor =
                context.spawn(DeliveryApp.create(), "Delivery");

            DeliveryRoutes deliveryRoutes = new DeliveryRoutes(context.getSystem(), deliveryActor);
            startHttpServer(deliveryRoutes.OrderRoutes(), context.getSystem());
